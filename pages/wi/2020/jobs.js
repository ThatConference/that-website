...
const jobs = () => {
  ...
  return (
    <>
      <NextSeo
        title="2020 Jobs - THAT Online"
        description="Job openings for all 2020 THAT partners"
      />
      ...
      <ContentSection>
        {filteredPartners.map(partner => (
          <PartnerSection key={partner.id}>
            ...
            <Jobs>
              {sortBy(partner.jobListings, j => j.title.toLowerCase()).map(
                job => (
